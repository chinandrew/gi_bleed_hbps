...
class SamplerOptions():
    ...
    def __init__(self, coef_sampler_type,
        ...
        """
        if coef_sampler_type not in ('cholesky', 'cg', 'hmc', 'nuts', 'hbps', 'hbpsnuts', 'bps'):
    ...
    def pick_default_and_create(coef_sampler_type, options, model_name, design):
        ...
        if coef_sampler_type not in (None, 'cholesky', 'cg', 'hmc', 'nuts', 'hbps', 'hbpsnuts', 'bps'):
...
class MarkovChainManager():
    ...
    def get_sampling_info_keys(self, sampling_method):
        ...
        elif sampling_method in ['hbps', 'bps']:
            keys = ['num_bounces']
        elif sampling_method in ['hbpsnuts']:
            keys = ['num_bounces', 'tree_height']
        else:
            keys = []
        return keys
